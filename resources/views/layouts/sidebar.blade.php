    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset("/bower_components/AdminLTE/dist/img/open4digital.png") }}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ url('employee-management') }}"><i class="fa fa-id-badge"></i> <span>Employee</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-gears"></i> <span>System</span>
